...
export const ERRORS = {
    ...
    UNHANDLED_ERROR: new RequestError("Some unhandled error occured at server", 10007, 500),
    CONNOT_DETERMINE_TIME: new RequestError("Some unhandled error occured at server", 10008, 500),
    INTERNAL_SERVER_ERROR: new RequestError("Internal server error", 10009, 500),
    ADMIN_ONLY_ROUTE: new RequestError("Only admin is allowed to access this route", 10010, 403),
    FILE_NOT_FOUND: new RequestError("File not found", 10011, 400),
    INVALID_FILE_TYPE: new RequestError("Invalid file type. Only PNG, JPEG and JPG are allowed", 10012, 400),
    INVALID_PARAMS: new RequestError("Invalid params", 10013, 400),
    ...
    INVALID_CREDENTIALS: new RequestError("Invalid credentials", 20011, 401),
    USER_INACTIVE: new RequestError("User is inactive", 20012, 403),
