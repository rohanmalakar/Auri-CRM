...
import { orgLogout } from "@/redux/features/orgAuth/orgAuthSlice";
...
const nav: NavItem[] = [
  ...
  { to: "/org/users", label: "Users", icon: Users, adminOnly: true },
  { to: "/org/branches", label: "Branches", icon: Building2, adminOnly: true },
  { to: "/org/organization", label: "Organization", icon: Globe2 },
  { to: "/org/loyalty", label: "Loyalty", icon: Gift, adminOnly: true },
];

export default function OrgUserLayout() {
  ...
  const filteredNav = nav.filter(item => !item.adminOnly || isOrgAdmin);
  ...
  return (
    <div className="min-h-screen flex bg-white text-gray-900 dark:bg-zinc-950 dark:text-zinc-100 transition-colors duration-300">
        ...
        <div className="h-16 flex items-center justify-between px-4 border-b border-gray-200 dark:border-zinc-800">
          <AnimatePresence>
            {open && (
              ...
              >
                <img src={logo} alt="Organization Logo" className="h-10 w-auto object-contain" />
              </motion.div>
            )}
          </AnimatePresence>
        ...
        {/* {open && isOrgAdmin && (
          <div className="px-4 py-2 bg-blue-50 dark:bg-blue-900/20 border-b border-blue-100 dark:border-blue-900/30">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-medium text-blue-700 dark:text-blue-300">Organization Admin</span>
            </div>
          </div>
        )} */}
        ...
        <header className="sticky top-0 z-10 h-16 bg-white/80 dark:bg-zinc-900/80 backdrop-blur-md border-b border-gray-200 dark:border-zinc-800 flex items-center justify-between px-4 sm:px-6 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              ...
              {isOrgAdmin && (
                <span className="text-xs text-blue-600 dark:text-blue-400">Admin Access</span>
              )}
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            {/* Notifications */}
            <button className="p-2 rounded-full hover:bg-gray-100 dark:hover:bg-zinc-800 transition-colors text-gray-500 dark:text-zinc-400">
