...
// =========================================================
// SUB-COMPONENT: Free Product Selector
// Handles the complex search, tabs, and selection logic
// =========================================================
function FreeProductSelector({ register, watch, setValue, index, errors }: Props) {
  const [activeTab, setActiveTab] = useState<"LIST" | "SELECTED">("LIST");
  
  // Watch specific fields for this reward index
  // @ts-ignore
  ...
  return (
    <div className="space-y-4 animate-in fade-in slide-in-from-top-2 border border-gray-100 dark:border-zinc-800 p-4 rounded-xl bg-gray-50/50 dark:bg-zinc-800/30">
      ...
      {/* 2. Selected Products Summary Chips */}
      {freeProducts.length > 0 && (
        <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 space-y-3">
          <h4 className="text-sm font-medium text-gray-700 dark:text-gray-300">Selected Products ({freeProducts.length})</h4>
            ...
            <div key={prodIndex} className="flex items-center gap-3 bg-white dark:bg-zinc-900 p-3 rounded-lg border border-blue-100 dark:border-blue-800">
              <div className="flex-1">
                <p className="text-sm font-medium text-gray-900 dark:text-gray-100">
                  {product.product_source === "INTERNAL" ? "Internal" : "External"} ID: {product.internal_product_id || product.external_product_id}
                </p>
              </div>
        ...
        <div className="border border-gray-200 dark:border-zinc-700 rounded-xl overflow-hidden bg-white dark:bg-zinc-900">
          ...
          <div className="p-4 min-h-64">
            ...
            <div className="space-y-1 max-h-60 overflow-y-auto pr-1 custom-scrollbar">
              ...
              {(productSource === "INTERNAL" ? MOCK_INTERNAL_PRODUCTS : MOCK_FOODICS_PRODUCTS).map((product) => {
  ...
  return (
    <div className="bg-white dark:bg-zinc-900 p-6 rounded-xl shadow-sm border border-gray-100 dark:border-zinc-800 space-y-6">
      ...
      <div className="space-y-5">
        ...
        {/* --- 1. FREE PRODUCT LOGIC (Extracted to Component) --- */}
